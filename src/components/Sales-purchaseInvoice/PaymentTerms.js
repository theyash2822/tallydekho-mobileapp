    ...
    <>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.box}>
          <Text style={styles.title}>Remarks and PaymentTerms</Text>
          <Text style={styles.label}>Payment Terms</Text>
          <TouchableOpacity onPress={toggleDropdown} style={styles.dropdown}>
            <Text style={{color: selectedRef ? Colors.black : '#999'}}>
              {selectedRef || 'Choose Terms'}
            </Text>
            <Ionicons
          ...
          <Text style={[styles.label, {marginTop: 6}]}>Narration/Remarks</Text>
          <TextInput
...
export default RemarksPaymentTerms;
