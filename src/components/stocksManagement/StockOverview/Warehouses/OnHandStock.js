...
const OnHandStock = () => {
  ...
  // Dummy data for on-hand stock items
  const onHandStockItems = [
    {
      id: 'ohs-1',
      name: 'Black JBL',
      sku: 'PRD-1002-ABC',
  ...
  const filteredItems = onHandStockItems.filter(
    item =>
  ...
  const renderStockItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate('onHandStockItemDetail', {
          itemName: item.name,
          productId: item.sku,
        })
      }
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.summaryCard}>
          ...
          <Text style={styles.summaryTitle}>On Hand stock</Text>
