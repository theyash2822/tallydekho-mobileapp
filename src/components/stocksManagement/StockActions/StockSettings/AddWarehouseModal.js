...
import { useInputNavigation } from '../../StockOverview/TotalStock/Components/inputNavigation';
import {validatePhoneNumber, validateEmail} from '../../../../utils/Validations';

const AddWarehouseModal = ({visible, onClose, onSave}) => {
  ...
  const handleSave = async () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        // Call onSave to add warehouse to the list
        if (onSave) {
          onSave(newWarehouse);
        }
